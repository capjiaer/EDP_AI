...
pv_calibre:
  dependency:
    FP_MODE:
      - step1:
          sub_steps:
            pv_calibre_sub_step1.tcl: pv_calibre::sub_step1
            pv_calibre_sub_step2.tcl: pv_calibre::sub_step2
```

**格式说明**：
- Key：文件名（如 `pv_calibre_sub_step1.tcl`），可以是任意文件名
- Value：proc 名称（如 `pv_calibre::sub_step1`，使用 Tcl namespace 语法）
...
```tcl
# pv_calibre_sub_step1.tcl
proc ::pv_calibre::sub_step1 {} {
    global edp project pv_calibre
...
pv_calibre::sub_step1
pv_calibre::sub_step2
```
