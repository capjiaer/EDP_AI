...
```
flow/initialize/SAMSUNG/S8/common/cmds/eco_pt/
├── steps/              # 主脚本目录
...
eco_pt:
  dependency:
    FP_MODE:
      - step1:
          sub_steps:
            eco_pt_sub_step1.tcl: eco_pt::sub_step1
            eco_pt_sub_step2.tcl: eco_pt::sub_step2
```

**格式说明**：
- Key：文件名（如 `eco_pt_sub_step1.tcl`），可以是任意文件名
- Value：proc 名称（如 `eco_pt::sub_step1`，使用 Tcl namespace 语法）
...
```tcl
# eco_pt_sub_step1.tcl
proc ::eco_pt::sub_step1 {} {
    global edp project eco_pt
