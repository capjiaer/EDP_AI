...
```
flow/initialize/SAMSUNG/S8/common/cmds/eco_pc/
├── steps/              # 主脚本目录
...
eco_pc:
  dependency:
    FP_MODE:
      - step1:
          sub_steps:
            eco_pc_sub_step1.tcl: eco_pc::sub_step1
            eco_pc_sub_step2.tcl: eco_pc::sub_step2
```

**格式说明**：
- Key：文件名（如 `eco_pc_sub_step1.tcl`），可以是任意文件名
- Value：proc 名称（如 `eco_pc::sub_step1`，使用 Tcl namespace 语法）
...
```tcl
# eco_pc_sub_step1.tcl
proc ::eco_pc::sub_step1 {} {
    global edp project eco_pc
