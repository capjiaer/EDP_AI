...
source C:/Users/anping.chen/Desktop/EDP_AI/Example/WORK_PATH/dongting/P111/B1/anping.chen/firest/runs/pnr_innovus.place/full.tcl
...
# 更新执行计划变量（包含 sub_steps 和中间代码 proc）
# 这会覆盖 full.tcl 中的执行计划（如果存在），添加中间代码
...
# 初始化 edp_sub_steps_manager（使用执行计划）
edp_run -init edp(execution_plan,place)

# 停止执行，进入交互模式（tclsh 会自动进入交互模式）
return
